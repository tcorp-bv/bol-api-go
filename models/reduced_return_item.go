...
// ReducedReturnItem reduced return item
//
// swagger:model ReducedReturnItem
...
// Validate validates this reduced return item
func (m *ReducedReturnItem) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ReducedReturnItem) validateProcessingDateTime(formats strfmt.Registry) error {
...
func (m *ReducedReturnItem) validateRegistrationDateTime(formats strfmt.Registry) error {
...
func (m *ReducedReturnItem) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ReducedReturnItem) UnmarshalBinary(b []byte) error {
	var res ReducedReturnItem
