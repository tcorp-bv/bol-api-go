...
// Validate validates this stock create
func (m *StockCreate) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *StockCreate) validateAmount(formats strfmt.Registry) error {
...
func (m *StockCreate) validateManagedByRetailer(formats strfmt.Registry) error {
...
func (m *StockCreate) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StockCreate) UnmarshalBinary(b []byte) error {
	var res StockCreate
